    ...
    <div className="py-16">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <section className="mt-14">
          <h2 className="text-xs font-mono uppercase tracking-wide text-[var(--muted)] mb-6">Our Approach</h2>
        ...
        {/* What We Do */}
        <section className="mt-14">
          <h2 className="text-xs font-mono uppercase tracking-wide text-[var(--muted)] mb-6">What We Do</h2>
          <div className="max-w-2xl space-y-8">
            ...
            <p className="text-[var(--muted)] font-light leading-relaxed border-l border-[var(--cloud)] pl-4">
              The lab produces the intellectual scaffolding that customers look for when navigating ambiguity in data quality, data selection, medical complexity, and annotation strategy—including methodological advice, evaluation design, and guidance on safe and effective use of sensitive real-world data.
            </p>
          </div>
        </section>

        {/* Join Us */}
        <section className="mt-14 pt-8 border-t border-[var(--cloud)]">
          <h2 className="text-xs font-mono uppercase tracking-wide text-[var(--muted)] mb-4">Join Us</h2>
